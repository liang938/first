...
void main()
{
    ...
    while(1)
	{
		...
		//oled_uint16(0,1,2333);					//显示一个16位无符号变量
		oled_int16(0,2,num);					//显示一个16位有符号变量
      //  oled_printf_int32(0,3,5693,5);          //显示一个变量  去除无效0位
        //oled_printf_float(0,4,56.356,5,2);      //显示一个浮点数 去除无效0位  整数位显示5位  小数位显示2位
