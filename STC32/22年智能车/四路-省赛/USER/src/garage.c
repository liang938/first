...
//出库左转:+60																									右转:-60
	...
	pwm_duty(PWMA_CH2P_P62, 8000);						//左轮pwm置0	      pwm_duty(PWMA_CH2P_P62, 8000);
...
//打角倒车入库，左边：+60                             右边：-60
	pwm_duty(PWMB_CH1_P74,840-60);				//            pwm_duty(PWMB_CH1_P74,840-60);
	pwm_duty(PWMA_CH1P_P60, 8000);				//左电机			pwm_duty(PWMA_CH1P_P60, 8000);
	pwm_duty(PWMA_CH4P_P66, 5000);				//右电机			pwm_duty(PWMA_CH4P_P66, 5000);
	delay_ms(300);
//入库后向后倒退，车身完全进入车库
	pwm_duty(PWMB_CH1_P74,840);
